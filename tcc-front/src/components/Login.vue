<template>
  <div style="margin:13%">
    <h1>Login</h1 >
      ...
      <br>
      <md-button @click="changePage('/CriarEmpresa/1')" class="md-raised md-primary">Cadastrar nova empresa</md-button>
    </div>
  </template>
    ...
    methods: {
      ...
      criar : function(){
        ...
        .then(function (response) {
          ...
          that.$session.set('tipo',response.data.tipo);
          ...
          .then(function (response) {
            ...
            that.$session.set('id_empresa',response.data.fk_empresa);
